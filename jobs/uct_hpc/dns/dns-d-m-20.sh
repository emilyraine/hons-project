...
#SBATCH --job-name="dns-d-m-20"
#SBATCH --output=/scratch/rnxemi001/jobs/dns-d-m-20.out 
#SBATCH --error=/scratch/rnxemi001/jobs/dns-d-m-20.err 
...
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -s config/dns/dns-difficult_maze-medium.properties dns-d-m-16
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -s config/dns/dns-difficult_maze-medium.properties dns-d-m-17
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -s config/dns/dns-difficult_maze-medium.properties dns-d-m-18
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -s config/dns/dns-difficult_maze-medium.properties dns-d-m-19
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -s config/dns/dns-difficult_maze-medium.properties dns-d-m-20
