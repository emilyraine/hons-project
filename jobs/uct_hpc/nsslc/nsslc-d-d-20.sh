...
#SBATCH --job-name="nsslc-d-d-20"
#SBATCH --output=/scratch/rnxemi001/jobs/nsslc-d-d-20.out 
#SBATCH --error=/scratch/rnxemi001/jobs/nsslc-d-d-20.err 
...
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -s config/nsslc/nsslc-difficult_maze-difficult.properties nsslc-d-d-16
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -s config/nsslc/nsslc-difficult_maze-difficult.properties nsslc-d-d-17
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -s config/nsslc/nsslc-difficult_maze-difficult.properties nsslc-d-d-18
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -s config/nsslc/nsslc-difficult_maze-difficult.properties nsslc-d-d-19
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -s config/nsslc/nsslc-difficult_maze-difficult.properties nsslc-d-d-20
