...
#SBATCH --job-name="nsslc-d-e-20"
#SBATCH --output=/scratch/rnxemi001/jobs/nsslc-d-e-20.out 
#SBATCH --error=/scratch/rnxemi001/jobs/nsslc-d-e-20.err 
...
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -s config/nsslc/nsslc-difficult_maze-easy.properties nsslc-d-e-16
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -s config/nsslc/nsslc-difficult_maze-easy.properties nsslc-d-e-17
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -s config/nsslc/nsslc-difficult_maze-easy.properties nsslc-d-e-18
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -s config/nsslc/nsslc-difficult_maze-easy.properties nsslc-d-e-19
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -s config/nsslc/nsslc-difficult_maze-easy.properties nsslc-d-e-20
