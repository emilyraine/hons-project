...
#SBATCH --job-name="ssga-d-e-20"
#SBATCH --output=/scratch/rnxemi001/jobs/ssga-d-e-20.out 
#SBATCH --error=/scratch/rnxemi001/jobs/ssga-d-e-20.err 
...
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -s config/ssga/ssga-difficult_maze-easy.properties ssga-d-e-16
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -s config/ssga/ssga-difficult_maze-easy.properties ssga-d-e-17
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -s config/ssga/ssga-difficult_maze-easy.properties ssga-d-e-18
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -s config/ssga/ssga-difficult_maze-easy.properties ssga-d-e-19
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -s config/ssga/ssga-difficult_maze-easy.properties ssga-d-e-20
