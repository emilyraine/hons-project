...
#SBATCH --job-name="ssga-d-m-20"
#SBATCH --output=/scratch/rnxemi001/jobs/ssga-d-m-20.out 
#SBATCH --error=/scratch/rnxemi001/jobs/ssga-d-m-20.err 
...
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -s config/ssga/ssga-difficult_maze-medium.properties ssga-d-m-16
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -s config/ssga/ssga-difficult_maze-medium.properties ssga-d-m-17
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -s config/ssga/ssga-difficult_maze-medium.properties ssga-d-m-18
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -s config/ssga/ssga-difficult_maze-medium.properties ssga-d-m-19
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -s config/ssga/ssga-difficult_maze-medium.properties ssga-d-m-20
