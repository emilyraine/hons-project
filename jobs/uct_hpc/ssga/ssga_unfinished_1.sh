...
#SBATCH --job-name="ssga_unfinished_1"
#SBATCH --output=/scratch/rnxemi001/jobs/ssga_unfinished_1.out 
#SBATCH --error=/scratch/rnxemi001/jobs/ssga_unfinished_1.err 
...
SDL_VIDEODRIVER=dummy SDL_AUDIODRIVER=dummy python run.py -r output/run_ssga-e-e-12/checkpoints/gen_63.pkl
